        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, exports.User.find(filter)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, exports.User.create(user)];
                    case 2: return [2 /*return*/, (_a.sent())];
                    case 3:
                        e_2 = _a.sent();
                        throw new Error(e_2);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, exports.User.findOne(filter)];
                    case 2: return [2 /*return*/, (_a.sent())];
                    case 3:
                        e_3 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, exports.User.findById(_id)];
                    case 2: return [2 /*return*/, (_a.sent())];
                    case 3:
                        e_4 = _a.sent();
                        return [2 /*return*/, false];
